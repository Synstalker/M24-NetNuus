	...
	static function optionsframework_tabs()
	{
		...
		foreach ($options as $value)
		{
			...
			if ( $value['type'] == "heading" )
			{
				...
				{
					$page_capabilities[sanitize_title($value['name'])] = $value['capability'];
	...
	static function optionsframework_fields()
	{
		...
		foreach ($options as $value)
		{
			...
			switch ($value['type'])
			{
				...
				// Multi Uploader
				case "multiupload":
					$output .= Options_Framework_Media_Uploader::optionsframework_multi_uploader($value['id'], $val, null);
