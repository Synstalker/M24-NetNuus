...
//	wp_enqueue_style( '_s-style', get_stylesheet_uri() );
	...
	if( is_front_page() ){
		wp_enqueue_script( 'moon-boy-project', get_template_directory_uri() . '/assets/js/project.js', array( 'jquery' ), MOON_BOY_VER , true );
	}
