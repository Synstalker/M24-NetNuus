<?php
/**
 * OnNet Framework Plugin: Theme Plugin Dependencies
 * Description: Let themes add dependencies on plugins in ways they might find useful
 * Version: 1.0.0
...
function theme_register_required_plugins()
{
	 ...
	 */
	$plugins = apply_filters('theme_plugins_dependencies', array());
	if(empty($plugins))
	{
		return;
	}
